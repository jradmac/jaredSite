...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto flex max-w-fit flex-row items-center justify-center overflow-hidden cursor-pointer ${showBorder ? 'rounded-[1.25rem] py-1 px-2' : ''} ${className}`}
    ...
    >
      {showBorder && (
        ...
        >
          <div className="absolute rounded-[1.25rem] z-[-1]" style={{ width: 'calc(100% - 2px)', height: 'calc(100% - 2px)', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'var(--color-parchment)' }} />
        </motion.div>
      )}
      <motion.div
