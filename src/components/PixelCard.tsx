...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden rounded-2xl border border-[var(--color-rule)] bg-[var(--color-parchment)] isolate transition-colors duration-200 select-none ${className}`}
